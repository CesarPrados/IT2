...
#define STRING_CONFIG_H_AUTHOR "(Jose Antonio Perez Caparros, First config)" //Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {81,81,2555.195,760*1.1}  // default steps per unit for ultimaker 
