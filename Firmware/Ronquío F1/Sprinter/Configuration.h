...
#define _AXIS_STEP_PER_UNIT {80, 80, 2555.195, 807.927}
...
#define _DEF_CHAR_UUID "Ronquío-Sprin-nov-2012-0000-00000000000"
...
//-- By JAPC:
//-- Default values:    kp = 2777, ki = 45, kd = 10699
//-- Autotuning 1 for Ronquío: kp = 2338, ki = 77, kd = 4430
//-- Autotuning 2 for Ronquío: kp = 2235, ki = 69, kd = 4517
//-- Autonuning 3 for Ronquío: kp = 2493, ki = 79, kd = 4881


#define PID_PGAIN 2493 //256 is 1.0  // value of X means that error of 1 degree is changing PWM duty by X, probably no need to go over 25

#define PID_IGAIN 79 //256 is 1.0  // value of X (e.g 0.25) means that each degree error over 1 sec (2 measurements) changes duty cycle by 2X (=0.5) units (verify?)

#define PID_DGAIN 4881 //256 is 1.0  // value of X means that around reached setpoint, each degree change over one measurement (half second) adjusts PWM by X units to compensate
